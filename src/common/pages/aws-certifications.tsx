...
import { Details, NavigationMenu } from "@not-govuk/components";
...
const Page: FC<PageProps> = (props) => (
  <Fragment>
    ...
    <main className="govuk-grid-column-three-quarters">
      ...
      <Details summary="AWS Cloud Practitioner">
        <p>
          This fundamental-level course is intended for individuals who seek an
        ...
        <p>Exam Cost: Free</p>
        <p>
          Recommended length of experience: Six months of fundamental AWS Cloud
          and industry knowledge or 6 hours of online courses
        </p>
        <p>
      ...
      <Details summary="AWS Associate Certifications">
        <p>
        ...
        <ul>
          <li>
            ...
            intended for individuals who perform a solutions architect role and
            have one or more years of hands-on experience designing available,
            cost-efficient, fault-tolerant, and scalable distributed systems on
            AWS.
          </li>
          <li>
            ...
            with at least one year of experience in deployment, management, and
            operations on AWS.
          </li>
          <li>
            The AWS Certified Developer Associate certification is intended for
            individuals who perform a development role and have one or more
            years of hands-on experience developing and maintaining an AWS-based
            application.
          </li>
        </ul>
        <p>Format: Multiple Choice</p>
      ...
      <Details summary="AWS Professional Certifications">
        <p>
        ...
        <ul>
          <li>
            The AWS Certified Solutions Architect Professional certification is
            intended for individuals who perform a solutions architect role with
            two or more years of hands-on experience managing and operating
            systems on AWS.
          </li>
          <li>
            The AWS Certified DevOps Engineer Professional certification is
            intended for individuals who perform a DevOps engineer role with two
            or more years of experience provisioning, operating, and managing
            AWS environments.
          </li>
        </ul>
      ...
      <Details summary="AWS Specialiality Certifications">
        <p>
          This is an advanced level of certification for users that have a high
          level of specialist technical AWS cloud experience.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            individuals who perform complex Big Data analyses with at least two
            years of experience using AWS technology. A new version of the AWS
            Certified Big Data – Specialty exam will be available in April 2020
            with a new name, AWS Certified Data Analytics – Specialty.
          </li>
          <li>
        ...
        <p>Exam Cost: Free</p>
        <p>
          Recommended length of experience: Several years of AWS experience with
          hands on experience in the specialist area
        </p>
        <p>
          How to book the exam: Please email:{" "}
          <a href="mailto:public.cloud@homeoffice.gov.uk">
